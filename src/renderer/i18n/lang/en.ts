export const en = {
  ...
  "chat.subAgentReadOnly": "Sub-agent view is read-only",
  "chat.subAgentStop": "Stop sub-agent task",
  "chat.subAgentStopping": "Stopping sub-agent task",
  ...
  "settings.featurePromptsSettings": "Feature prompts",
  "settings.builtinServicesSettings": "Built-in services",
  "featurePrompts.title": "Built-in feature prompts",
  "featurePrompts.info": "Edit the prompts used by Snow App's built-in AI features. Changes take effect immediately and are stored locally.",
  "featurePrompts.close": "Close feature prompts settings",
  "featurePrompts.save": "Save",
  "featurePrompts.saved": "Prompt saved.",
  "featurePrompts.reset": "Reset to default",
  "featurePrompts.resetDone": "Prompt reset to default.",
  "featurePrompts.resetAll": "Reset all modified ({{count}})",
  "featurePrompts.resetAllDone": "All prompts reset to defaults.",
  "featurePrompts.modified": "Modified",
  "featurePrompts.loadError": "Failed to load feature prompts",
  "featurePrompts.saveError": "Failed to save the prompt",
  "featurePrompts.resetError": "Failed to reset the prompt",
  "featurePrompts.commitMessage.name": "Git commit message",
  "featurePrompts.commitMessage.description": "Prompt used to generate Git commit messages from staged changes.",
  "featurePrompts.summary.name": "Conversation title",
  "featurePrompts.summary.description": "Prompt used to generate conversation titles.",
  "featurePrompts.themePalette.name": "Theme palette",
  "featurePrompts.themePalette.description": "Prompt used to derive a theme color palette from a background image.",
  "featurePrompts.planMode.name": "Plan mode system prompt",
  "featurePrompts.planMode.description": "Template body of the Plan mode system prompt. Dynamic context (working directory, platform, date) is appended automatically.",
  "featurePrompts.goalMode.name": "Goal mode system prompt",
  "featurePrompts.goalMode.description": "Template body of the Goal mode system prompt. Dynamic context (working directory, platform, token budget) is appended automatically.",
  "featurePrompts.codebaseReview.name": "Code search review",
  "featurePrompts.codebaseReview.description": "Prompt used to review code search results for relevance.",
  "featurePrompts.vision.name": "Image description",
  "featurePrompts.vision.description": "Prompt used to describe images when the main model does not support vision.",
  "builtinServices.title": "Built-in services",
  "builtinServices.info": "Globally enable or disable Snow App's built-in MCP services. Disabled services' tools are hidden from the AI model and cannot be called.",
  "builtinServices.close": "Close built-in services settings",
  "builtinServices.loadError": "Failed to load built-in services status",
  "builtinServices.saveError": "Failed to update built-in services status",
  "builtinServices.saved": "Settings saved. Disabled services are hidden from the model.",
  "builtinServices.disabledHint": "{{count}} service(s) disabled — their tools are currently invisible to the model.",
  "builtinServices.filesystem.name": "Filesystem",
  "builtinServices.bash.name": "Terminal",
  "builtinServices.todo.name": "TODO",
  "builtinServices.grep.name": "Search",
  "builtinServices.websearch.name": "Web search",
  "builtinServices.browser.name": "Browser",
  "builtinServices.userInteraction.name": "User interaction",
  "builtinServices.subAgents.name": "Sub-agents",
  "builtinServices.codebase.name": "Codebase",
  "builtinServices.codelens.name": "CodeLens",
